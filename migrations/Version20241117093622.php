 ...
 */
final class Version20241117093622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ouvertures (id INT AUTO_INCREMENT NOT NULL, day VARCHAR(255) NOT NULL, open_morning DOUBLE PRECISION NOT NULL, closed_morning DOUBLE PRECISION NOT NULL, open_evening DOUBLE PRECISION NOT NULL, closed_evening DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
